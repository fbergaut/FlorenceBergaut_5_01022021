...
.then(data => {
  ...
  mainImg.src = arnold.imageUrl;
  mainImg.alt = arnold.name;
  ...
  h1Info.innerHTML = arnold.name;
  divDescriptionProduct.innerHTML = arnold.description;
  divPriceProduct.innerHTML = arnold.price + " €";
  ...
  let colorsOption = arnold.colors;
