...
//                             <h1 class="heading">${garfunkel.name}</h1>
//                               <a class="heartBtn">
//                                 <i class="fas fa-heart" aria-hidden="true"></i>
//                               </a>
//                             </div>
//                           <div class="text">${garfunkel.description}</div>
...
//                             <i class="fas fa-star reviewBtn" aria-hidden="true"></i>
//                           </div>
//                           <p class="price">${garfunkel.price / 100} €</p>
